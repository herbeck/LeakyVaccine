...
getIntroContent <- function() {
  return (tabPanel("Introduction",
    ...
    p("It is hypothesized that exposure heterogeneity (i.e. variation among individuals in the rate of pathogen exposure) can affect efficacy estimation for leaky vaccines (e.g. Halloran et al., 1992; White et al., 2010; O'Hagan et al.,2013; Edlefsen, 2014; Coley et al., 2016; Gomes et al., 2016; Kahn et al., 2018). Our goal is to make a simple deterministic compartmental model to facilitate straightforward simulation-based evaluation of this process within and across populations, in the context of HIV prevention trials or longitudinal studies."),
    HTML("<ol type='1'>"),
    HTML("<li>Assess if this effect might contribute to the differences between the RV 144 and HVTN 702 vaccine trial outcomes.</li>"),
    HTML("<li>Assess if this effect might contribute to waning efficacies seen in HIV prevention trials (specifically the AMP VRC01 bnAb trial).</li>"),
