...
First pass at the size of these risk subpopulations are 10% high risk, 60% medium risk, and 30% no (zero) risk. (This parameterization is difficult:  Dimitrov et al 2015 even suggest that the MAJORITY of individuals in trials are NOT exposed; https://pubmed.ncbi.nlm.nih.gov/25569838/)
...
Instantaneous incidence / hazard, for homogeneous risk, for placebo and vaccine arms
