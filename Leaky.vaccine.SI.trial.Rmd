...
plot(density(fit$param[, 1], from = 0.00001,  to = 0.0001),
     main = "density plot for lambda", 
     xlim = c(0.000008, 0.0001),
     ylim = c(0, 1000))
#lines(density(fit$param[, 1], from = 0.00007,  to = 0.0001), col = 2)
#abline(v = 0.00009, lty = 2, col = 1)
#legend("topright", legend = c("Prior", "Posterior", "Truth"),
#      lty = c(1, 1, 2), col = 1:2, lwd = 2)

plot(density(fit$param[, 2], from = 1, to = 20),
     main = "density plot for risk multiplier", ylim = c(0, 2))
