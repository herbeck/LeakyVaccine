...
init <- init.dcm(Sp = 5000, Ip = 0,
                 Sv = 5000, Iv = 0,
                 Sph = 500, Iph = 0,    #Susceptible, Infected, placebo, high risk
                 Spm = 4000, Ipm = 0,   #Susceptible, Infected, placebo, medium risk
                 Spl = 500, Ipl = 0,    #Susceptible, Infected, placebo, low risk
